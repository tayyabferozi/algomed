          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="">
              ...
              <input
                ...
                type="checkbox"
                value=""
                className="mt-5 w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
            </div>
            <div className="">
              <label
